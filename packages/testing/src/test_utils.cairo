...
pub fn set_account_as_governance_admin(
    ...
    roles_dispatcher.register_governance_admin(:account);
}
...
pub impl TokenHelperImpl of TokenHelperTrait {
    ...
    fn approve(self: @Token, owner: ContractAddress, spender: ContractAddress, amount: u256) {
