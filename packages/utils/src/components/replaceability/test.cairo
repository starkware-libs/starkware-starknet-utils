mod ReplaceabilityTests {
    ...
    use starkware_utils::components::roles::interface::{ICommonRolesDispatcher, ICommonRolesDispatcherTrait, Role};
    ...
    fn test_upgrade_governor_can_use_replaceability() {
        ...
        ICommonRolesDispatcher { contract_address }.grant_role(role: Role::UpgradeGovernor, :account);
        ...
        replaceable_dispatcher.add_new_implementation(
            implementation_data: DUMMY_NONFINAL_IMPLEMENTATION_DATA(),
        );
    }
}
