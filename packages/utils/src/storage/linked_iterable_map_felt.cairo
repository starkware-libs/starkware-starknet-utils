...
pub impl StoragePathMutableLinkedIterableMapImpl_2<
    K, V, +CastableFelt<K>, +Castable160<V>, +Drop<K>, +Drop<V>,
...
// --- Helpers for cross-module usage ---
