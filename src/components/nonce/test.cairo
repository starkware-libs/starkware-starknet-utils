...
use starkware_utils::components::nonce::mock_contract::NonceMock;
use starkware_utils::components::nonce::nonce::NonceComponent;
use starkware_utils::components::nonce::nonce::NonceComponent::InternalTrait;
