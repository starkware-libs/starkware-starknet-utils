...
fn grant(address: ContractAddress, dispatcher: ICommonRolesDispatcher, role: Role, to: ContractAddress) {
    cheat_caller_address_once(contract_address: address, caller_address: constants::INITIAL_ROOT_ADMIN);
...
fn test_only_upgrade_governor_authorized() {
    ...
    cheat_caller_address_once(contract_address: address, caller_address: constants::UPGRADE_GOVERNOR);
...
fn test_only_security_governor_authorized() {
    ...
    cheat_caller_address_once(contract_address: address, caller_address: constants::SECURITY_GOVERNOR);
