...
pub(crate) mod Constants {
    ...
    pub(crate) const WRONG_ADMIN: ContractAddress = 'WRONG_ADMIN'.try_into().unwrap();

    pub(crate) const INITIAL_ROOT_ADMIN: ContractAddress = 'INITIAL_ROOT_ADMIN'.try_into().unwrap();
    ...
    pub(crate) const OPERATOR: ContractAddress = 'OPERATOR'.try_into().unwrap();
