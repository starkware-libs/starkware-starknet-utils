//! # Shared Types Module
//!
//! This module contains constants, enums, events, and error definitions shared across
//! the delayed executor contracts and multi-owned component.
...
pub struct CallSetSubmitted {
    ...
    /// Timestamp when the call set becomes executable.
    pub enable_time: u64,
}
...
pub struct OwnershipNominationCleared {
    /// Address of the owner whose nomination was cleared.
    #[key]
    pub owner: ContractAddress,
    /// Address that was previously nominated but is now revoked.
    #[key]
...
pub mod Errors {
    ...
    pub const NOT_DESIGNATED_OWNER: felt252 = 'NOT_DESIGNATED_OWNER';
